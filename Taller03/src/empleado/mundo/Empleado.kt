...
class Empleado {
     ...
     * @return Fecha de ingreso del empleado como un String
     */
    ...
    fun calcularEdad(): Int {
        ...
        val mes = fechaNacimiento.darDiferenciaEnMeses(hoy)
        return mes / 12
    }
    ...
    fun calcularAntiguedad(): Int {
        val hoy = darFechaActual()
        val mes = fechaIngreso.darDiferenciaEnMeses(hoy)
        return mes / 12
    }

    /**
     * Retorna las prestaciones del empleado usando la fórmula: p = (a * s)/4
     * (p: prestaciones, a: antigüedad, s: salario). <br></br>
    ...
    fun calcularPrestaciones(): Double {
        val prestaciones = (this.calcularAntiguedad() * this.salario)/4
        return prestaciones
    }
     ...
     * @return Fecha actual.
     */
    private fun darFechaActual(): Fecha {
     ...
     * "sophomore" si el empleado tiene entre 1 y 5 años de antigüedad
     * "junior" si el empleado tiene más de 5 pero menos de 10 años de antigüedad
     * "senior" si tiene 10 o más años de antigüedad
     */
    fun tipo(): String {
        val antiguedad = calcularAntiguedad()
        return when{
            (antiguedad < 1) -> "freshman"
            (antiguedad in 1 .. 5) -> "sophomore"
            (antiguedad in 6 .. 9) -> "junior"
            else -> "senior"
     ...
     * Este valor se calcula a partir del nueve por ciento (11%) del salario dividido por el número de
     * personas a cargo (dato de entrada).
     */
    fun bonificacion(numPersonasACargo: Int): Double {

        return this.salario * 0.11 / numPersonasACargo
    }
}